<template>
  <div class="servicios-container">
    ...
    <div class="create-card">
      ...
      <div class="form-grid">
        <div class="input-group">
          ...
          <input v-model="nuevo.nombre" placeholder="Ej: Spa, Desayuno, Lavandería" />
        </div>
        <div class="input-group">
          <label>Precio</label>
          <input v-model="nuevo.precio" placeholder="Ej: 50.00" type="number" step="0.01" />
        </div>
    ...
    <div v-if="!servicios.length && !error" class="alert alert-info">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <circle cx="12" cy="12" r="10"></circle>
    ...
    <!-- Tabla de servicios -->
    <div class="table-container" v-if="servicios.length">
      <table class="servicios-table">
        ...
        <tbody>
          <tr v-for="s in servicios" :key="s.id">
            ...
            <td>
              <input v-model="s.nombre" class="table-input" />
            </td>
            <td>
              <input v-model="s.precio" class="table-input" type="number" step="0.01" />
            </td>
            <td>
              <div class="action-buttons">
                <button @click="actualizar(s)" class="btn-save" title="Guardar cambios">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <button @click="desactivar(s)" class="btn-deactivate" title="Desactivar">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <circle cx="12" cy="12" r="10"></circle>
                    <line x1="4.93" y1="4.93" x2="19.07" y2="19.07"></line>
                  </svg>
                </button>
                <button @click="eliminar(s)" class="btn-delete" title="Eliminar permanentemente">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
